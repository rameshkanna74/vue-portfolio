...
async function handleSubmit() {
  ...
  try {
    // Placeholder for Django backend integration
    ...
    statusMessage.value = 'Failed to send message. Please try emailing me directly.';
        ...
        <div>
          <div class="relative overflow-hidden rounded-lg bg-nord-1/80 backdrop-blur-md border border-nord-3/50 p-6 transition-all duration-300 hover:bg-nord-1/90 hover:border-nord-8/70 hover:shadow-glow-md group">
            ...
            <div class="relative z-10">
              ...
              <form @submit.prevent="handleSubmit" class="contact-form space-y-5">
                <!-- Name Field -->
                <div>
                  <label class="block text-sm font-medium text-nord-6 mb-2 flex items-center gap-2">
                  ...
                  <Transition name="error-slide">
                    <p v-if="errors.name" class="mt-1.5 text-xs text-nord-11 font-mono flex items-center gap-1">
                ...
                <div>
                  ...
                  />
                  <Transition name="error-slide">
                    <p v-if="errors.email" class="mt-1.5 text-xs text-nord-11 font-mono flex items-center gap-1">
                      <Icon icon="mdi:alert-circle" class="w-3 h-3" />
                      {{ errors.email }}
                    </p>
                  </Transition>
                ...
                <div>
                  ...
                  />
                  <Transition name="error-slide">
                    <p v-if="errors.subject" class="mt-1.5 text-xs text-nord-11 font-mono flex items-center gap-1">
                      <Icon icon="mdi:alert-circle" class="w-3 h-3" />
                      {{ errors.subject }}
                    </p>
                  </Transition>
                ...
                <div>
                  ...
                  ></textarea>
                  <Transition name="error-slide">
                    <p v-if="errors.message" class="mt-1.5 text-xs text-nord-11 font-mono flex items-center gap-1">
                      <Icon icon="mdi:alert-circle" class="w-3 h-3" />
                      {{ errors.message }}
                    </p>
                  </Transition>
