    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="relative hidden sm:block" ref="themeMenuRef">
            ...
            >
              <button
                ...
                class="w-full text-left px-4 py-2 text-xs font-mono hover:bg-nord-2 transition-all duration-200 flex items-center justify-between group"
          ...
          <button
            @click="toggleMenu"
            class="md:hidden text-nord-4 hover:text-terminal-green transition-colors p-2"
